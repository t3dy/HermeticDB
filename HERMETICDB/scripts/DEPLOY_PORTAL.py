...
def deploy_to(target_dir, cursor):
    ...
    LOCATION_TAGLINES = {
        ...
        # Journey-stop locations
        "toulouse":          "Bruno's doctorate city; Averroist milieu; first stable academic base (1579–81)",
        "wittenberg":        "Luther's university; Bruno lectured here and praised the Reformation (1586–88)",
        "helmstedt":         "Bruno's last Protestant refuge; excommunicated by Lutherans before returning south",
        "grenoble":          "Agrippa's final refuge; died here in poverty, 1535",
        "dole":              "Agrippa's first controversy: accused of Judaizing before Margaret of Austria (1509)",
        "pavia":             "Agrippa's first university lectures on the Hermetic Corpus (1512–15)",
        "metz":              "Agrippa defended a woman from witchcraft charges, attacking the Malleus Maleficarum",
        "lyon":              "Agrippa physician to Louise of Savoy; composed De incertitudine et vanitate",
        "antwerp":           "Agrippa's court historian post; De Occulta Philosophia prepared for publication",
        "cambridge":         "Dee's formation at St John's and Trinity College; bedrock of English mathematics",
        "louvain":           "Dee studied with Mercator and Gemma Frisius; foundation of his instrument collection",
        "krakow":            "Dee and Kelley with Albert Łaski; staging point for Rudolf II's Prague court",
        "trebon":            "Kelley's transmutation claim; angel-conversation crisis; Dee and Kelley's parting",
        "trittenheim":       "Birthplace of Johannes Trithemius (1462) — the great abbot and cryptographer",
        "heidelberg":        "Trithemius's university formation among the Rhenish Humanists",
        "sponheim":          "Trithemius's monastery; 2000-volume library; Steganographia composed here",
        "mirandola":         "Birthplace of Pico della Mirandola (1463); ancestral seat of his dynastic house",
        "bologna":           "Pico's first university; studies in canon law before turning to philosophy",
        "ferrara":           "Pico's Averroist studies; first encounters with Kabbalistic texts (c. 1479–80)",
        "padua":             "Pico with Elia del Medigo; Averroism and the opening of the Kabbalistic tradition",
        "gayhurst":          "Digby's birthplace; Catholic recusant household after Gunpowder Plot (1603)",
        "algiers":           "Digby ransomed English captives from Barbary corsairs, February 1628",
        "milos":             "Digby's first powder-of-sympathy experiment at sea, spring 1628",
        "scanderoon":        "Battle of Scanderoon, June 1628: Digby defeats Venice and France",
        "frankfurt":         "European book fair hub; Bruno's printers; Trithemius's correspondence network",
        "geneva":            "Bruno's brief Calvinist refuge; excommunicated; 'one Inquisition to another'",
    }
    ...
    JOURNEYS = {
        "giordano_bruno": {
            "name": "Giordano Bruno",
            "life": "Dominican Friar, Memory Magician & Cosmologist, 1548–1600",
            "stops": [
                {"label": "Nola / Naples", "lat": 40.85, "lng": 14.27, "year": "1548–1576",
                 "bullets": [
                    "Born at Nola, near Naples, c. 1548; always called himself 'the Nolan' with deliberate provincial pride",
                    "Entered the Dominican monastery of San Domenico Maggiore, Naples, at c. 14; the same convent where Thomas Aquinas had taught",
                    "Absorbed Neoplatonist currents from the circle of Giovanni Battista della Porta; developed his distinctive memory art using charged magical images",
                    "First controversy: stripped devotional images from his cell, leaving only a crucifix; suspected of concealing works by Erasmus",
                    "Fled the order in 1576 when a full heresy investigation began — he had voiced doubts about transubstantiation and the Arian heresy",
                 ]},
                {"label": "Rome", "lat": 41.90, "lng": 12.50, "year": "1576",
                 "bullets": [
                    "Sought refuge briefly at the monastery of Sant'Angelo in Rome; discovered he was still under investigation",
                    "Fled Rome for the north; the Church's long arm would shadow him for the rest of his life",
                    "Wandered through Genoa, Savona, and Turin; briefly taught grammar and the sphere of the world to children in Noli for meagre income",
                 ]},
                ...
                {"label": "Toulouse", "lat": 43.60, "lng": 1.44, "year": "1579–1581",
                 "bullets": [
                    "Awarded the doctorate in theology at the University of Toulouse — the first formal degree of his itinerant career",
                    "Lectured publicly on Aristotle's De anima and on his own mnemonic art; won a devoted student following",
                    "The city's parlementaire culture tolerated his unorthodox views more than Geneva had",
                    "Toulouse was a centre of Averroist scholasticism; Bruno absorbed and transformed its naturalist currents",
                 ]},
                {"label": "Paris", "lat": 48.86, "lng": 2.35, "year": "1581–1583",
                ...
                {"label": "Wittenberg", "lat": 51.87, "lng": 12.64, "year": "1586–1588",
                 "bullets": [
                    "Fled Paris after his patron Castelnau was recalled to France; wandered through German Protestant cities",
                    "Received warmly at the Lutheran University of Wittenberg — Luther's own institution",
                    "Delivered a celebrated farewell oration praising Luther as a liberator of the intellect",
                    "His enthusiasm for Luther was strategic: he saw Protestant humanism as an ally against scholastic Aristotelianism, not as a theological conversion",
                 ]},
                {"label": "Helmstedt", "lat": 52.23, "lng": 11.01, "year": "1589",
                 "bullets": [
                    "Took up residence at the newly founded University of Helmstedt under the protection of Julius, Duke of Brunswick",
                    "Delivered an oration commemorating the Duke — his most direct public statement of Hermes-inflected natural theology",
                    "Excommunicated by the Lutheran consistory after a dispute with the local superintendent",
                    "Left Helmstedt for Frankfurt; his receptive audience in Protestant Germany was definitively exhausted",
                 ]},
        ...
        "cornelius_agrippa": {
            ...
            "stops": [
                ...
                {"label": "London", "lat": 51.51, "lng": -0.13, "year": "1510",
                 "bullets": [
                    "Visits England as part of an imperial diplomatic mission; meets the humanist circle of John Colet at St Paul's Cathedral",
                    "Colet, Thomas More, and Erasmus were the core of English Christian humanism — exactly Agrippa's intellectual milieu",
                    "His London visit confirmed his conviction that learned religious reform and Hermetic natural philosophy were compatible",
                 ]},
                {"label": "Pavia", "lat": 45.19, "lng": 9.16, "year": "1512–1515",
                 "bullets": [
                    "Lectures at the University of Pavia on Hermes Trismegistus and the Pauline epistles",
                    "Delivers what may be the first university lecture course in history devoted explicitly to the Hermetic Corpus",
                    "Marries his first wife; develops his Hermetic theology in dialogue with Neoplatonist colleagues",
                    "Loses his position when French forces sack Pavia; begins a decades-long pattern of wandering",
                 ]},
                ...
                {"label": "Grenoble", "lat": 45.19, "lng": 5.72, "year": "1535",
                 "bullets": [
                    "Flees Germany after further pursuit by Dominican inquisitors and creditors",
                    "Dies at Grenoble in early 1535, in poverty and relative obscurity, aged 48",
                    "His death brings no closure to the controversies he had ignited: De Occulta Philosophia continues to circulate and influence for centuries",
                    "Later traditions would embellish his end with legends of a dog-familiar who abandoned him at death — the persistent mythologisation of his life had begun",
                 ]},
            ]
        },
        "john_dee": {
            ...
            "stops": [
                ...
                {"label": "Mortlake, London", "lat": 51.47, "lng": -0.27, "year": "1551–1583",
                 "bullets": [
                    "Builds one of Europe's greatest private libraries at his Mortlake home on the Thames: over 3,000 volumes — rivalling the collections of Oxford colleges",
                    "Serves as astrologer and scientific advisor to Elizabeth I; consults on her coronation date and advises on naval policy and exploration",
                    "From 1581 begins the 'actions': systematic angelic conversations with the scryer Edward Kelley using a polished obsidian mirror and a shew-stone (crystal sphere)",
                    "The angels deliver the Enochian language — a complete angelic tongue with its own alphabet, grammar, and Tables of Leaves — which becomes foundational to Western ceremonial magic",
                 ]},
                ...
                {"label": "Třeboň, Bohemia", "lat": 49.01, "lng": 14.77, "year": "1586–1589",
                 "bullets": [
                    "Hosted by the Bohemian nobleman Wilhelm von Rosenberg at Třeboň Castle — a major centre of Rudolphine alchemical culture",
                    "Kelley claims to transmute base metal into gold at Třeboň; Rudolf II grants him the title of knight and a manor",
                    "The angels command Dee and Kelley to share their wives in a communal experiment — a crisis that finally fractures their partnership",
                    "Dee refuses to accept further angelic messages; Kelley parts ways permanently and remains in Bohemia as a celebrated court alchemist",
                    "Dee resolves to return to England after six years of wandering across the Continent",
                 ]},
                {"label": "Mortlake, London", "lat": 51.47, "lng": -0.27, "year": "1589–1608",
        ...
        "johannes_trithemius": {
            ...
            "stops": [
                ...
                {"label": "Sponheim", "lat": 49.89, "lng": 7.57, "year": "1483–1506",
                 "bullets": [
                    "Arrives at the Benedictine monastery of Sponheim almost by accident during a snowstorm; elected Abbot aged 21",
                    "The community had only ten monks and forty-eight books; Trithemius builds the library to over 2,000 volumes through relentless acquisition and correspondence",
                    "Writes Liber de scriptoribus ecclesiasticis (1494) — the first printed bio-bibliography of Christian authors",
                    "Writes the Steganographia: ostensibly a system for communicating with angels across distances, it was long condemned as demonic; scholars in 1996–1998 confirmed it encodes a genuine cryptographic cipher throughout its first two books",
                    "His monks eventually rebel against his strict rule; he is forced to resign the abbacy in 1506",
                 ]},
        ...
        "kenelm_digby": {
            ...
            "stops": [
                ...
                {"label": "Algiers", "lat": 36.73, "lng": 3.09, "year": "February 1628",
                 "bullets": [
                    "Digby's squadron anchors off Algiers to ransom English captives held by Barbary corsairs — a diplomatic and humanitarian mission combined with privateering objectives",
                    "Negotiates with the Dey of Algiers; secures the release of English prisoners",
                    "The Algiers stopover demonstrates Digby's dual role as royal agent and independent adventurer, navigating the boundary between diplomacy and piracy",
                 ]},
                {"label": "Milos, Greece", "lat": 36.69, "lng": 24.43, "year": "Spring 1628",
                 "bullets": [
                    "At the island of Milos in the Cyclades, Digby conducts his first documented alchemical experiment at sea",
                    "Attempts to treat wounded sailors using vitriol (copper sulphate solution) as an ingredient in the 'powder of sympathy' — action-at-a-distance wound healing",
                    "The experiment, later described in his Discourse on the Powder of Sympathy, became famous across Europe and was debated at the Royal Society thirty years later",
                    "Milos marks the fusion of Digby's naval command with his emerging career as an experimenter in Paracelsian natural philosophy",
                 ]},
                {"label": "Scanderoon (Iskenderun)", "lat": 36.60, "lng": 36.17, "year": "June 1628",
                 "bullets": ["Commands his squadron at the Battle of Scanderoon, June 1628: defeats a combined Venetian and French fleet", "The victory — won against superior forces — makes him famous across Europe as a commander of extraordinary boldness", "He returns to England a celebrated hero; Charles I rewards him with gifts and royal favour"]},
                {"label": "Paris", "lat": 48.86, "lng": 2.35, "year": "1636–1638",
                 "bullets": [
                    "Venetia dies suddenly in May 1633; Digby, devastated, commissions a death-mask and portraits from Van Dyck and retires to Paris",
                    "Meets René Descartes in 1637; they hold extended philosophical conversations — Digby later becomes one of the earliest English expositors of Cartesian mechanism",
                    "Attends Mersenne's circle at the Minim convent; encounters Hobbes, Gassendi, and the leading mechanist philosophers of Europe",
                    "Begins systematic chemical experiments; accumulates the five thousand pages of laboratory notebooks that will underpin his later published works",
                 ]},
                {"label": "London", "lat": 51.51, "lng": -0.13, "year": "1641–1643",
                 "bullets": [
                    "Returns briefly to England as the political crisis deepens; arrested briefly in 1641 on suspicion of Catholic conspiracy",
                    "Attempts to mediate between Parliament and Charles I; fails and is banished from England",
                    "Publishes his Observations upon Religio Medici (1643) — a remarkable response to Thomas Browne's meditation on faith and science",
                 ]},
                {"label": "Paris", "lat": 48.86, "lng": 2.35, "year": "1644–1660",
                 "bullets": [
                    "Long Royalist exile at the court of Henrietta Maria; Chancellor of her household",
                    "Continues chemical experiments and philosophical writing; accumulates vast manuscript notes on nutrition, vegetation, and sympathetic action",
                    "Discourse on the Vegetation of Plants (delivered at the Montmor Academy, Paris, 1658) — argues for a universal spirit-agency in plant growth, in Paracelsian terms",
                    "Maintains correspondence with Samuel Hartlib's network as a bridge between English and Continental natural philosophy",
                 ]},
                {"label": "London", "lat": 51.51, "lng": -0.13, "year": "1660–1665",
                 "bullets": [
                    "Returns to England with the Restoration of Charles II; immediately active in the circle that founds the Royal Society (1660)",
                    "Among the founding Fellows of the Royal Society — the living embodiment of the transition from Hermetic natural philosophy to the 'new science'",
                    "His 1658 Discourse on the Powder of Sympathy is reprinted and debated; Robert Boyle challenges the sympathetic action-at-a-distance theory",
                    "Publishes A Choice Collection of Rare Secrets and The Closet of Sir Kenelm Digby Opened (posthumous, 1669)",
                    "Dies 11 June 1665, the same year as the Great Plague; remembered as the last great exponent of the Hermetic-magical philosophy within the walls of the new scientific institution",
                 ]},
            ]
        },
    }
